...
const benefits = [
  {
    ...
    description:
      "Your property receives professional photography, virtual tours, and premium listing placement across all major platforms.",
    variant: "default",
  },
  {
    number: "02",
    ...
    description:
      "Accurate pricing strategies based on comprehensive market analysis and comparable property evaluations.",
    variant: "accent",
  },
  {
    number: "03",
    ...
    description:
      "A single point of contact handles all viewings, negotiations, and paperwork throughout your sale.",
    variant: "default",
  },
  {
    number: "04",
    ...
    description:
      "Streamlined digital process with full transparency at every stage from offer to closing.",
    variant: "accent",
  },
];
              ...
              className={`
                ...
                ${
                  benefit.variant === "accent"
                    ? "bg-yellow-50 border-slate-200 hover:bg-slate-50"
