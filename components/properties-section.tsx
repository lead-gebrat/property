...
export default function PropertiesCarousel() {
  ...
  const prevSlide = () => {
    ...
    setIsTransitioning(true);
    setCurrentIndex(
      (prev) => (prev - 1 + managedProperties.length) % managedProperties.length
    );
    setTimeout(() => setIsTransitioning(false), 300);
  };
    ...
    <section className="py-20 px-4 md:px-8 lg:px-16 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-light text-yellow-700 tracking-wide mb-4">
            PROPERTIES MANAGED BY US
          </h2>
          <div className="w-16 h-px bg-gray-900 mx-auto mb-6"></div>
          <p className="text-gray-600 font-light max-w-2xl mx-auto">
            Discover our portfolio of expertly managed properties, delivering
            exceptional returns and tenant satisfaction
          </p>
        </div>
