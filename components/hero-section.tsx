    ...
    <div className="w-screen h-screen bg-black relative overflow-hidden">
      ...
      <nav className="relative z-20 flex items-center justify-between p-8 animate-fade-in">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          {["Portfolio", "Services", "Testimonials", "Contact"].map(
            (item, index) => (
              <a
                key={item}
                href="#"
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <div className="max-w-4xl">
            <h1 className="text-7xl lg:text-8xl xl:text-9xl font-light text-white leading-[0.9] mb-8 animate-slide-in-up">
              ...
              <br />
              <span className="bg-yellow-600 bg-clip-text text-transparent font-normal animate-slide-in-left">
                Management
              </span>
            </h1>
            <p className="text-xl text-white/80 max-w-2xl leading-relaxed animate-fade-in-delayed">
              Elevating real estate through bespoke management solutions.
              Experience seamless property care with our white-glove service.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-8 right-8 z-20 flex items-end justify-between animate-slide-in-bottom">
        ...
        <div className="text-right max-w-md">
          ...
          <div className="mt-2 text-amber-400/80 text-sm font-medium">
            — ETProperty Ethos
          </div>
        </div>
      </div>
